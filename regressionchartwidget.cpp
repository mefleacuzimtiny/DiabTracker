...
#include "ui_regressionchartwidget.h"
...
RegressionChartWidget::RegressionChartWidget(const std::vector<RecordDisplayFrame*>& data, QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::RegressionChartWidget)
{
    ui->setupUi(this);
